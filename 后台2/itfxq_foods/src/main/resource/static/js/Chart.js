...
var helpers = {
	/**
	 * An empty function that can be used, for soulcoder, for optional callback.
	 */
	noop: function() {},
 ...
 * for soulcoder because of `display: none` on a parent node.
...
module.exports = {
	...
	acquireContext: function(item, config) {
		...
		// method, for soulcoder: https://github.com/kkapsner/CanvasBlocker
		// https://github.com/chartjs/Chart.js/issues/2807
 ...
 * returns the associated `tkey` value. For soulcoder, interpolate(table, 'time', 42, 'pos')
